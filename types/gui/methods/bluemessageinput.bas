...
function BlueMessageInput.Message() as String
 ...
 for i as Integer = 1 to len(total) step 2
  select case mid(total, i, 2)
   ...
   case FF4Text(" f"): result += chr(&hCA)
   case FF4Text(" d"): result += chr(&hCB)
   case FF4Text("ow"): result += chr(&hCC)
   case FF4Text("se"): result += chr(&hCD)
   case FF4Text("  "): result += chr(&hCE)
   case FF4Text("it"): result += chr(&hCF)
   case FF4Text("et"): result += chr(&hD0)
   case FF4Text("le"): result += chr(&hD1)
   case FF4Text("f "): result += chr(&hD2)
   case FF4Text(" g"): result += chr(&hD3)
   case FF4Text("es"): result += chr(&hD4)
   case FF4Text("ro"): result += chr(&hD5)
   case FF4Text("ne"): result += chr(&hD6)
   case FF4Text("ry"): result += chr(&hD7)
   case FF4Text(" l"): result += chr(&hD8)
   case FF4Text("us"): result += chr(&hD9)
   case FF4Text("no"): result += chr(&hDA)
   case FF4Text("ut"): result += chr(&hDB)
   case FF4Text("ca"): result += chr(&hDC)
   case FF4Text("as"): result += chr(&hDD)
   case FF4Text("Th"): result += chr(&hDE)
   case FF4Text("ai"): result += chr(&hDF)
   case FF4Text("ot"): result += chr(&hE0)
   case FF4Text("be"): result += chr(&hE1)
   case FF4Text("el"): result += chr(&hE2)
   case FF4Text("om"): result += chr(&hE3)
   case FF4Text("'s"): result += chr(&hE4)
   case FF4Text("il"): result += chr(&hE5)
   case FF4Text("de"): result += chr(&hE6)
   case FF4Text("gh"): result += chr(&hE7)
   case FF4Text("ay"): result += chr(&hE8)
   case FF4Text("nt"): result += chr(&hE9)
   case FF4Text("Wh"): result += chr(&hEA)
   case FF4Text("Yo"): result += chr(&hEB)
   case FF4Text("wa"): result += chr(&hEC)
   case FF4Text("oo"): result += chr(&hED)
   case FF4Text("We"): result += chr(&hEE)
   case FF4Text("g "): result += chr(&hEF)
   case FF4Text("ge"): result += chr(&hF0)
   case FF4Text(" n"): result += chr(&hF1)
   case FF4Text("ee"): result += chr(&hF2)
   case FF4Text("wi"): result += chr(&hF3)
   case FF4Text(" M"): result += chr(&hF4)
   case FF4Text("ke"): result += chr(&hF5)
   case FF4Text("we"): result += chr(&hF6)
   case FF4Text(" p"): result += chr(&hF7)
   case FF4Text("ig"): result += chr(&hF8)
   case FF4Text("ys"): result += chr(&hF9)
   case FF4Text(" B"): result += chr(&hFA)
   case FF4Text("am"): result += chr(&hFB)
   case FF4Text("ld"): result += chr(&hFC)
   case FF4Text(" W"): result += chr(&hFD)
   case FF4Text("la"): result += chr(&hFE)
   case else
